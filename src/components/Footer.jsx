...
const Footer = () => {
  ...
  return (
    <footer className='w-full px-6 pt-12 pb-6 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800'>
              ...
              {navbarLinks
                ...
                .map((link) => (
                  <li key={link.title}>
                    <Link
                      to={link.url}
                      className='text-sm text-gray-600 dark:text-gray-400 hover:text-green dark:hover:text-green-400 transition-colors duration-200'
                    >
                      {link.title}
                    </Link>
                  </li>
            ...
            <div className='flex flex-wrap gap-3'>
              {socialLinks.map((social) => (
                <a
                  ...
                  className='flex items-center gap-2 px-3 py-2 bg-gray-100 hover:bg-green-100 text-gray-700 hover:text-green-700 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-gray-200 dark:hover:text-green-400 rounded-lg text-sm transition-colors duration-200'
                >
                  {social.icon}
