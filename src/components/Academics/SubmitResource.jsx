  ...
  return (
    <div className="text-center mt-10">
      ...
      <AnimatePresence>
        {showForm && (
          <motion.div
            className="fixed inset-0 bg-black/60 backdrop-blur-md z-modal flex items-center justify-center px-4"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          >
                  ...
                  >
                    <div className="col-span-2">
                      ...
                      >
                        <input
                          ...
                          required
                          className="w-full border-2 border-dashed border-gray-200 p-6 rounded-2xl hover:border-green-400 hover:bg-green-50/30 transition cursor-pointer text-sm font-medium"
                          disabled={isUploading}
                        />
                        {file && (
                    ...
                    <div className="col-span-2">
                      ...
                      <select
                        ...
                        required
                        className="w-full border-2 border-green-50 px-5 py-3.5 rounded-2xl appearance-none bg-gray-50 focus:ring-4 focus:ring-green-500/10 focus:border-green-500 outline-none transition font-medium text-gray-700"
                        disabled={isUploading}
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        required
                        className="w-full border-2 border-green-50 px-5 py-3.5 rounded-2xl bg-gray-50 focus:ring-4 focus:ring-green-500/10 focus:border-green-500 outline-none transition font-medium text-gray-700"
                        disabled={isUploading}
                      >
                    ...
                    <div className="col-span-2">
                      ...
                      <input
                        ...
                        required
                        className="w-full border-2 border-green-50 px-5 py-3.5 rounded-2xl bg-gray-50 focus:ring-4 focus:ring-green-500/10 focus:border-green-500 outline-none transition font-medium text-gray-700 uppercase"
                        disabled={isUploading}
                      />
                    </div>
                  </motion.div>
