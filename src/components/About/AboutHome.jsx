        ...
        <div className='mb-12'>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-14 items-center'>
            <div className='relative mb-20'>
                ...
                <div className='relative h-90 lg:h-120'>
                  {images.map((photo, index) => (
                    <img
                      ...
                      src={photo}
                      alt={photo}
                      className={`rounded-lg shadow-lg w-full h-90 lg:h-120 object-fill order-2 absolute transition-opacity duration-500 ${
              ...
              <div className='absolute -bottom-30 md:-bottom-10 -right-6 bg-white p-6 py-4 rounded-lg shadow-lg max-w-xs overflow-x-hidden'>
