  ...
  return (
    <section ref={submitRef} className="py-16 md:py-24 px-4 border-t border-green-100">
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Submit */}
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-[0_8px_30px_rgba(15,81,50,0.06)] p-8">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-[0_8px_30px_rgba(15,81,50,0.06)] p-8">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 border border-green-700 text-green-700 dark:text-green-400 px-6 py-3 rounded-md font-semibold hover:bg-green-50 transition-colors duration-200 text-sm"
          >
      ...
      >
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed inset-0 z-modal flex items-center justify-center px-4 py-8">
            <div className="bg-white dark:bg-gray-900 rounded-2xl max-w-xl w-full p-6 relative max-h-[90vh] overflow-y-auto shadow-[0_24px_80px_rgba(3,14,7,0.35)]">
              <Dialog.Close
                aria-label="Close"
              ...
              <Dialog.Title className="text-2xl font-bold text-green-700 dark:text-green-400 mb-4 pr-8">
                Submit Your Article
              </Dialog.Title>

              {submitted ? (
                <p className="text-green-600 dark:text-green-400 text-center font-semibold py-6">
                ...
                <form onSubmit={handleFormSubmit} className="space-y-4 text-sm">
                  <input
                    ...
                    required
                    className="w-full border border-gray-200 dark:border-gray-800 dark:bg-gray-900 dark:text-white rounded-md px-4 py-2 focus:outline-none focus:border-green-500"
                  />
                  <input
                    type="text"
                    name="author"
