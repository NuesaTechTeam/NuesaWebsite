...
const EventsHome = () => {
  ...
  const NoEventsCard = () => (
    <div className='bg-white rounded-2xl overflow-hidden border border-gray-200 p-8 text-center'>
      <div className='mb-6'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='order-2 lg:order-1'>
            <div className='relative'>
              <div className='bg-white rounded-2xl overflow-hidden border border-gray-200 transition-colors duration-200 hover:border-green-300'>
                ...
                <div className='p-6'>
                  ...
                  {hasUpcomingEvents ? (
                    ...
                    <button className='w-full bg-gray-100 hover:bg-gray-200 text-gray-700 py-3 px-6 rounded-xl font-semibold transition duration-300 cursor-not-allowed'>
                      Event Completed
                    </button>
                  )}
                </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
            {featuredEvents
              ...
              .map((event) => (
                <div
                  key={event.id}
                  className='bg-white rounded-2xl border border-gray-200 overflow-hidden hover:border-green-300 transition-colors duration-200'
                >
                  <img
                    src={event.image}
                    alt={event.title}
            ...
            <div className='bg-green-50 rounded-2xl border border-dashed border-green-300 p-6 flex flex-col items-center justify-center text-center hover:bg-green-100 transition-colors duration-200 cursor-pointer'>
              {hasUpcomingEvents ? (
