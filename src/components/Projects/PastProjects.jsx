...
const projects = [
  {
    ...
    summary: "Installations of fans in classes around the Engineering college for a more conducive learning environment.",
    status: "past",
    year: 2015,
  ...
  {
    title: "Findr",
    summary: "A simple platform to help university students connect with their roommates before resumption for better bonding.",
    status: "past",
    year: 2024,
  ...
  return (
    <section className="max-w-7xl mx-auto pt-4 pb-10 px-4">
      ...
      <p className="text-center text-gray-600 max-w-2xl mx-auto mb-10">
        Browse through the completed and previously implemented NUESA initiatives.
      </p>
