    ...
    <div>
      <div className='relative flex flex-col md:flex-row bg-white rounded-xl shadow-md overflow-hidden'>
        ...
        <div className='p-6 flex-1'>
          ...
          <p className='text-gray-700 text-sm line-clamp-10 mb-6'>{active.summary}</p>
          ...
          {active.link && (
            <a
              ...
              className="inline-flex items-center px-6 py-2.5 bg-green-600 text-white font-medium rounded-full shadow-md hover:bg-green-700 hover:shadow-lg transition-all duration-300 gap-2 transform hover:-translate-y-0.5"
            >
              Visit Project
      ...
      <div className='mt-6 flex gap-6 overflow-x-auto px-2 py-8 scrollbar-hidden'>
        {projects.map((proj, idx) => (
          <div
            key={idx}
            onClick={() => goTo(idx)}
            className={`flex-shrink-0 w-65 p-2 bg-white border rounded-xl overflow-hidden text-left transition-all duration-300 ${idx === currentIndex
                ...
                {modalProject.link && (
                  <div className="mt-6 text-center">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-block px-6 py-3 bg-green-600 text-white rounded-full font-semibold hover:bg-green-700 transition shadow-md hover:shadow-lg"
                    >
                      Visit Project
                    </a>
                  </div>
