          ...
          <div className='space-y-6'>
            <div>
              ...
              <input
                ...
                className='w-full px-0 py-3 border-0 border-b-2 border-green-900 bg-transparent focus:border-green-600 focus:ring-0 focus:outline-none transition-colors duration-200'
                required
              />
            </div>
            <div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className='w-full px-0 py-3 border-0 border-b-2 border-green-900 bg-transparent focus:border-green-600 focus:ring-0 focus:outline-none transition-colors duration-200 resize-none'
                required
              />
            </div>
            <div className='pt-6'>
              <button
                ...
                className='w-full md:w-auto px-8 py-3 bg-green text-white font-medium rounded-lg hover:bg-green-800 focus:ring-2 focus:outline-none focus:ring-green-600 focus:ring-offset-2 cursor-pointer'
              >
                Send Message
              </button>
            </div>
