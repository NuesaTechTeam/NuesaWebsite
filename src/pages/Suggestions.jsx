                ...
                <div className="w-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-lg rounded-3xl p-8 sm:p-10 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center gap-5 mb-10 border-b border-gray-200 dark:border-gray-800 pb-8">
                            <div className="w-16 h-16 bg-green-100 dark:bg-green-900/40 text-green dark:text-green-400 rounded-2xl flex items-center justify-center shrink-0">
                                <Lightbulb className="w-8 h-8" />
                            </div>
                            <div>
                                <h1 className="text-3xl sm:text-4xl font-extrabold text-green dark:text-green-400 tracking-tight">Suggest an Idea</h1>
                                <p className="text-gray-600 dark:text-gray-300 mt-2 text-sm sm:text-base">Help us innovate. We'd love to hear your brilliant thoughts.</p>
                            </div>
                        </div>
                        ...
                        <form className="space-y-8" onSubmit={handleSubmit}>
                            ...
                            <div className="flex items-center justify-between p-5 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 transition hover:border-gray-300 dark:hover:border-gray-700 hover:shadow-md">
                                ...
                                <button
                                    ...
                                    className={`relative inline-flex h-7 w-12 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 ${isAnonymous ? 'bg-green' : 'bg-gray-200 dark:bg-gray-700'}`}
                                >
                            ...
                            <div className={`space-y-5 overflow-hidden transition-all duration-500 ease-out ${isAnonymous ? 'max-h-0 opacity-0 pointer-events-none' : 'max-h-[300px] opacity-100'}`}>
                                <div className="flex gap-4">
                                    <button
                                        ...
                                        className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-xl border text-sm font-bold transition ${contactMethod === 'email'
                                            ? 'border-green bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-400 shadow-sm'
                                    ...
                                    >
                                        <div className={`w-4 h-4 rounded-full border flex items-center justify-center transition-colors ${contactMethod === 'email' ? 'border-green' : 'border-gray-300 dark:border-gray-700'}`}>
                                    ...
                                    >
                                        <div className={`w-4 h-4 rounded-full border flex items-center justify-center transition-colors ${contactMethod === 'phone' ? 'border-green' : 'border-gray-300 dark:border-gray-700'}`}>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-5 py-3.5 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 focus:ring-2 focus:ring-green-500/20 focus:border-green outline-none transition text-gray-900 dark:text-white placeholder:text-gray-400 font-medium"
                            ...
                            {/* Details Section */}
                            <div>
                                <label htmlFor="suggestion" className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-2 pl-1">
                                    Suggestion Details
                                </label>
                                <textarea
                                    id="suggestion"
                                    ...
                                    className="w-full px-5 py-4 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 focus:ring-2 focus:ring-green-500/20 focus:border-green outline-none resize-none transition text-gray-900 dark:text-white placeholder:text-gray-400 font-medium leading-relaxed"
