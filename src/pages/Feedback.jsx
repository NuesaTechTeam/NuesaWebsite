...
const Feedback = () => {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-gray-900 flex flex-col items-center justify-center p-6 sm:p-12 font-sans text-gray-900 dark:text-white">
            <div className="z-10 w-full max-w-4xl text-center flex flex-col items-center py-8">
                ...
                <div className="relative mb-10 group">
                    ...
                    <img
                        ...
                        alt="NUESA Logo"
                        className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-2xl shadow-xl object-cover border border-white transition-transform duration-500 group-hover:scale-105 bg-white dark:bg-gray-900"
                    />
                </div>

                {/* Header */}
                <div className="mb-4">
                    <h1 className="relative text-4xl sm:text-6xl font-extrabold text-green dark:text-green-400 tracking-tight">
                        Have Your Say
                    </h1>
                </div>

                <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-14 max-w-2xl leading-relaxed">
                ...
                <div className="flex flex-col sm:flex-row gap-6 w-full max-w-3xl">
                    ...
                    <Link
                        ...
                        className="group relative flex-1 p-8 bg-green-50/50 dark:bg-green-900/30 border border-green-100 hover:border-green-700 rounded-3xl shadow-lg hover:shadow-xl hover:-translate-y-1 overflow-hidden transition duration-300"
                    >
                        ...
                        <div className="relative z-10 flex flex-col items-start text-left h-full">
                            <div className="w-14 h-14 bg-green-100 dark:bg-green-900/40 text-green-700 dark:text-green-400 rounded-2xl flex items-center justify-center shrink-0 mb-6 group-hover:scale-110 group-hover:bg-green-200 transition duration-300">
                            ...
                            <p className="text-base text-gray-600 dark:text-gray-300 group-hover:text-gray-700 transition-colors mb-8 leading-relaxed flex-1">
                                Notice something wrong? Report an issue or concern you've experienced so we can fix it.
                            </p>

                            <div className="mt-auto flex items-center text-green-700 dark:text-green-400 font-medium text-sm tracking-wide">
                    ...
                    <Link
                        ...
                        className="group relative flex-1 p-8 bg-green-50/30 dark:bg-green-900/30 border border-green-200 hover:border-green-600 rounded-3xl shadow-lg hover:shadow-xl hover:-translate-y-1 overflow-hidden transition duration-300"
                    >
                        ...
                        <div className="relative z-10 flex flex-col items-start text-left h-full">
                            <div className="w-14 h-14 bg-green-50 dark:bg-green-900/30 text-green-600 rounded-2xl flex items-center justify-center shrink-0 mb-6 group-hover:scale-110 group-hover:bg-green-100 transition duration-300">
