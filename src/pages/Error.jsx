...
const Error = () => {
  useSEO({
    ...
    description: "The page you are looking for has been disconnected or does not exist."
  });
        ...
        <div className="bg-white rounded-xl p-8 px-2 shadow-lg border border-gray-200 mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
            <button 
              ...
              className="group bg-green hover:bg-green-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
