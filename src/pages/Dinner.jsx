...
const Dinner = () => {
  useSEO({
    title: "Dinner Night - Casablanca",
    description: "Experience the annual NUESA Dinner and Awards Night. Get ticket information, event location, schedule, and look back at past awards."
  });
