...
const HeartPage = () => {
  ...
  useEffect(() => {
    ...
    const handleCounselorSelect = (memberName) => {
      setSelectedCounselor(memberName);
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-red-50 py-20 px-4 overflow-hidden border-b border-red-100">
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <button
            ...
            className="inline-flex items-center justify-center rounded-full bg-red-600 px-7 py-3 font-semibold text-white transition-colors duration-200 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
          >
      ...
      <div className="py-16 px-4 bg-pink-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-8 bg-green-700 rounded-xl p-6 text-center">
              ...
              >
                <div className="text-center">
                  ...
                  <div className="mt-4">
                    ...
                    <button
                      onClick={() => handleCounselorSelect(member.name)}
                      className="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-full text-sm font-medium transition-colors duration-200 flex items-center mx-auto focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                    >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-red-50 rounded-xl p-8 border border-red-100">
            ...
            <button
              ...
              className="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-4 rounded-lg transition-colors duration-200 flex items-center justify-center"
            >
      ...
      {/* Social Links */}
      <div className="py-12 px-4 bg-red-600">
          ...
          <div className="flex justify-center gap-6">
            {[
              ...
              <a
                ...
                className="bg-white/20 hover:bg-white/30 text-white p-4 rounded-full transition-colors duration-200 group"
              >
